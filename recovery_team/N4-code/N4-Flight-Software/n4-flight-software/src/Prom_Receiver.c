...
// #include <Arduino.h>
// const char* ssid = "Nakuja";  // Access Point SSID
// const char* password = "987654321";
// #define SP8T_PIN_1 17  // GPIO pin 17 for the first control pin
// #define SP8T_PIN_2 5  // GPIO pin 5 for the second control pin
// #define SP8T_PIN_3 18 // GPIO pin 18 for the third control pin
...
// // Define the target MAC address (replace with the desired MAC address)
// const uint8_t target_mac[6] = {0x08, 0xD1, 0xF9, 0x15, 0xA4, 0xA9}; 
...
//             Serial.printf("sinal strength:%d",rssi);
...
//     //                         data.altitude = AltitudeKalman;

//     // data.filtered_v = VelocityVerticalKalman;
//     // data.filtered_a = AccYInertial;
//     // data.state = flightState;
//                         // Serial.printf("gx: %d\n", data->gx);
//                         // Serial.printf("gy: %d\n", data->gy);
//                         // Serial.printf("gz: %d\n", data->gz);
//                         // Serial.printf("state: %d\n", data->longitude);
