...
bool parseCSV(const char* csv) {
  ...
  while (tok && f < 29) {
    switch (f) {
      ...
      case  3: telem.ax                    = strtof(tok,nullptr); break;
      case  4: telem.ay                    = strtof(tok,nullptr); break;
      case  5: telem.az                    = strtof(tok,nullptr); break;
      case  6: telem.pitch                 = strtof(tok,nullptr); break;
      case  7: telem.roll                  = strtof(tok,nullptr); break;
      case  8: telem.gx                    = strtof(tok,nullptr); break;
      case  9: telem.gy                    = strtof(tok,nullptr); break;
      case 10: telem.gz                    = strtof(tok,nullptr); break;
      case 11: telem.latitude              = strtof(tok,nullptr); break;
      case 12: telem.longitude             = strtof(tok,nullptr); break;
      case 13: telem.gps_altitude          = strtof(tok,nullptr); break;
      case 14: telem.gps_time              = (uint32_t)strtoul(tok,nullptr,10); break;
      case 15: telem.pressure              = strtof(tok,nullptr); break;
      case 16: telem.temperature           = strtof(tok,nullptr); break;
      case 17: telem.altitude_agl          = strtof(tok,nullptr); break;
      case 18: telem.velocity              = strtof(tok,nullptr); break;
      ...
      case 23: telem.battery_voltage       = strtof(tok,nullptr); break;
      case 24: telem.logic_rail_3v3_voltage= strtof(tok,nullptr); break;
      ...
      case 27: telem.kalman_altitude       = strtof(tok,nullptr); break;
      case 28: telem.kalman_vertical_velocity= strtof(tok,nullptr); break;
    }
